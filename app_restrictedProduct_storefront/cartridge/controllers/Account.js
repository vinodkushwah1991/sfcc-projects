 ...
 * @name app_custom_storefront/Account-Show
 * @function
 * @memberof Account
 ...
 * @name app_custom_storefront/Account-SubmitRegistration
 * @function
 * @memberof Account
 * @param {middleware} - server.middleware.https
                    ...
                    try {
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                newCustomerProfile.custom.vinodDOB = new Date(registrationForm.dob);  // registrationForm.dob;
